...
export default function NotFoundPage() {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
      ...
      <div className="w-16 h-[2px] bg-terracotta mt-6 mb-6" />
      <Link
        to="/"
        className="font-ui font-bold uppercase text-sm tracking-[0.2em] text-terracotta hover:text-sienna transition-colors"
      >
        Back to home &rarr;
      </Link>
    </section>
